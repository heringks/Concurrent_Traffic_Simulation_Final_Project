...
void TrafficLight::cycleThroughPhases()
{
    ...
    int kRange = 2000;   // Range between minimum and maximum cycle durations in ms
    ...
    while (true)
    {
        ...
        {
            // Toggle the phase of the light under the lock
            std::lock_guard<std::mutex> uLock(_mutex);
            _currentPhase = (_currentPhase == red) ? _currentPhase = green : _currentPhase = red;
